...
고정 입력 `n = 97`에 대해 `isPrimeTrial`을 실행하는 과정이다. `keyValue` 패널은 매 단계의 핵심 변수(`d`, `d*d`, `n mod d`)와 판정 진행 상황을 보여준다. 사전 처리(`n<2`, `n=2`, 짝수 검사)를 통과한 뒤 `d = 3, 5, 7, 9`를 시도하고, `d = 11`에서 `d*d = 121 > 97`이 되어 루프가 종료된다.

실제 반환값은 `true` 이며, 시뮬레이션 마지막 프레임의 결론과 일치한다.
...
export const steps = [
  {
    title: "사전 처리",
    detail: "n=97 은 2 이상, 2가 아니며, 홀수다. 사전 처리 통과 → 본 루프 진입.",
    entries: [
      { label: "n", value: 97 },
  ...
  {
    title: "d = 3",
    detail: "d*d = 9 <= 97 이므로 검사. 97 mod 3 = 1 != 0 → 약수 아님, d += 2.",
    entries: [
      { label: "d", value: 3 },
      { label: "d*d", value: 9 },
      { label: "d*d <= n", value: "true" },
      { label: "n mod d", value: 1 },
    ],
  },
  {
    title: "d = 5",
    detail: "d*d = 25 <= 97 이므로 검사. 97 mod 5 = 2 != 0 → 약수 아님, d += 2.",
    entries: [
      { label: "d", value: 5 },
      { label: "d*d", value: 25 },
      { label: "d*d <= n", value: "true" },
  ...
  {
    title: "d = 7",
    detail: "d*d = 49 <= 97 이므로 검사. 97 mod 7 = 6 != 0 → 약수 아님, d += 2.",
    entries: [
      { label: "d", value: 7 },
      { label: "d*d", value: 49 },
      { label: "d*d <= n", value: "true" },
  ...
  {
    title: "d = 9",
    detail: "d*d = 81 <= 97 이므로 검사. 97 mod 9 = 7 != 0 → 약수 아님, d += 2.",
    entries: [
      { label: "d", value: 9 },
      { label: "d*d", value: 81 },
      { label: "d*d <= n", value: "true" },
      { label: "n mod d", value: 7 },
    ],
  },
  {
    title: "d = 11 → 루프 종료",
    detail: "d*d = 121 > 97 이므로 루프 조건 거짓. √n 이하에 약수가 없다.",
    entries: [
      { label: "d", value: 11 },
      { label: "d*d", value: 121 },
  ...
  },
  {
    ...
    detail: "어떤 d 도 97을 나누지 못했다 → 97은 소수. true 반환.",
    entries: [
...
<AlgorithmSimulation view="keyValue" steps={steps} title="isPrimeTrial: n=97" />
