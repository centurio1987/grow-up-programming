 ...
 * 자리다. 생성자는 자리 수에 비례하는 베끼기뿐이라 구성 상한 `O(n)` 안이고(1,024 · 4,096 · 16,384 — 정본의 5,109 · 20,466 · 81,899
 ...
 * 짓게 되므로 **둘 다 걸린다**(무작위 5,112 · 20,469 · 81,902 / 사슬 4,098 · 16,386 · 65,538 — 둘 다 $r$ = 4.00). 반면 호출 평균은
 * 저쪽처럼 「로그를 따라 자라 해상도 아래」가 아니라 **상수로 고정된다** — `amortized` 8.19 · 8.16 · 8.13 / 7.51 · 7.50 · 7.50 ·
 * `expected` 8.17 · 8.16 · 8.15 / 7.50 · 7.50 · 7.50(정본은 3.20 · 3.16 · 3.14 / 3.51 · 3.50 · 3.50 과 3.19 · 3.16 · 3.15 / 3.50 ·
 * 3.50 · 3.50). 지은 몫이 선형인데 그것을 나눠 갚을 걸음이 n 개라서다. 그러니 이 계열은 **약한 읽기 둘을 실제로 지키고**, 그것을
 * 배제하는 축은 `worst` 하나다. `inOrder` 시나리오는 그 행의 상한이 `O(n)` 이라 통과한다(6,143 · 24,575 ·
 * 98,303). 헤더 「여섯 연산이 모두 `worst` 인 근거」 문단이 이 수치를 쓰고, 자기시험은 `../runContract.cartesianTree.test.ts` 다.
 *
