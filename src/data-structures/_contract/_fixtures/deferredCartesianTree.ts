 ...
 * 저쪽처럼 「로그를 따라 자라 해상도 아래」가 아니라 **상수로 고정된다**(8.19 · 8.16 · 8.13 / 7.51 · 7.50 · 7.50 — 정본은 3.20 ·
 * 3.16 · 3.14 / 3.51 · 3.50 · 3.50) — 지은 몫이 선형인데 그것을 나눠 갚을 걸음이 n 개라서다. 그러니 이 계열은 상각 읽기를 **실제로
 * 지키고**, 그것을 배제하는 것은 `worst` 뿐이다. `inOrder` 시나리오는 그 행의 상한이 `O(n)` 이라 통과한다(6,143 · 24,575 ·
