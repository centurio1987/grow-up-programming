 ...
 *
 * **여덟째 시나리오의 탐침 조회는 항상 참인데 축3 이 그 답을 안 본다**(`KAN-043`). `valueContract` 가
...
runContract(() => new Treap<number>(), treapContract, {
  label: "스텁",
});

runContract(() => new Reference<number>(), treapContract, {
  label: "정본",
