...
const TRACKS: readonly Track[] = [
  ...
  { id: "T2", title: "우선순위 큐", facts: "120-139 · 250-269 · 300-309" },
  {
    id: "T3",
    title: "사전·집합·분리집합",
    facts: "140-159 · 310-319 · 340-349",
  },
  { id: "T4", title: "구간 질의·공간", facts: "160-179 · 320-329 · 330-339" },
  {
    id: "T5",
    title: "선형·확률·기타",
    facts: "180-199 · 90-99 · 230-249 · 343-349",
  },
  ...
  // 270-299 는 S14 · S19(TA-12 · TA-13)에서 소진됐고 셋째 대역 350-379 를 연다. 300-349 는 KAN-027 몫이다(380-389 는 KAN-027 이 쓰지 않고 반납 — 검토 #11 승인, KAN-027 S26 정정).
...
const UNITS: readonly Unit[] = [
  ...
  },
  {
    id: "T5-07",
    track: "T5",
    contract: "뿌리 결속 · 수열 없는 검증 · 로그 고치기(토큰 모형)",
    canonical: "tree/merkleTree",
    transitions: [],
    note: "착수 전 주의사항은 「불변 구조다 — 불변 사실 52 의 넷을 적용」이었다. **S17 판정: 불변 구조가 아니다**(불변 사실 343 — 물려받은 표면에 update 가 있고 뺄 근거가 서지 않았다). 넷은 적용하지 않고 T4-05 에서는 worst 계열 구분(328)만 인용했다. update 를 빼 불변 구조로 좁힐지는 사람 결정",
  },
  {
    id: "T5-08",
    track: "T5",
    contract: "고정한 패턴 집합의 모든 출현 · 불변 구조",
    canonical: "trie/ahoCorasick",
    transitions: [],
    note: "**S18 판정: 자료구조이고 불변 구조다**(불변 사실 247 — 답이 구성 입력과 텍스트만으로 정해진다). 결과에는 나타난 패턴만 키로 둔다(물려받은 「모든 패턴을 키로」는 검색을 패턴 수에 묶는다)",
  },
