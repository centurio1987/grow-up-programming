...
const SKELETON_EXEMPT = new Map([
  ...
  [
    "graph-repr/graphAdjMatrix",
    "KAN-026 S10 은 계약 전환만 한다(2026-09-14 유저 결재). 옛 가이드는 KAN-036 이 v2 로 " +
      "다시 쓸 때까지 옛 문형이다. 다시 쓰는 카드가 이 줄을 지운다",
  ],
  [
    "linear/bitArray",
    "KAN-026 S13 은 계약 전환만 한다(2026-09-14 유저 결재). 옛 가이드는 KAN-036 이 v2 로 " +
      "다시 쓸 때까지 옛 문형이다(뺀 count · toggle 과 워드 표현을 설명한다). 다시 쓰는 카드가 이 줄을 지운다",
  ],
  [
    "linear/doublyLinkedList",
    "KAN-026 S5 는 계약 전환만 한다(2026-09-14 유저 결재). 옛 가이드는 KAN-036 이 v2 로 " +
      "다시 쓸 때까지 옛 문형이다. 다시 쓰는 카드가 이 줄을 지운다",
  ],
  [
    "linear/dynamicArray",
  ...
  [
    ...
    "KAN-026 S8 은 계약 전환만 한다(2026-09-14 유저 결재). 옛 가이드는 KAN-036 이 v2 로 " +
      "다시 쓸 때까지 옛 문형이다(상태 없는 함수 둘을 설명한다). 다시 쓰는 카드가 이 줄을 지운다",
  ],
  [
    "linear/monotonicStack",
    "KAN-026 S7 은 계약 전환만 한다(2026-09-14 유저 결재). 옛 가이드는 KAN-036 이 v2 로 " +
      "다시 쓸 때까지 옛 문형이다(상태 없는 함수 셋을 설명한다). 다시 쓰는 카드가 이 줄을 지운다",
  ],
  [
    "linear/singlyLinkedList",
    "KAN-026 S4 는 계약 전환만 한다(2026-09-14 유저 결재). 옛 가이드는 KAN-036 이 v2 로 " +
      "다시 쓸 때까지 옛 문형이다. 다시 쓰는 카드가 이 줄을 지운다",
  ],
  [
    "linear/stack",
  ...
  [
    ...
    "KAN-026 S14 는 계약 전환만 한다(2026-09-14 유저 결재). 옛 가이드는 KAN-036 이 v2 로 " +
  ...
  [
    "trie/trie",
    "KAN-026 S2 는 성격 전환의 계약 산출만 한다(2026-09-14 유저 결재). 옛 가이드는 KAN-036 이 " +
      "v2 로 다시 쓸 때까지 옛 문형이다. 다시 쓰는 카드가 이 줄을 지운다",
  ],
]);
